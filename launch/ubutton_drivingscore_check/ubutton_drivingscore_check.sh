...
BIN="ROOT_DIR/src/bsw/ipc/src/ubutton_drivingscore_check_process/button_drivingscore_check_process"

# Load aliases/functions form bashrc so canstart alias is available
...
echo "[INFO] Starting Ubutton drivingscore check process"
echo "[INFO] $(date)"
