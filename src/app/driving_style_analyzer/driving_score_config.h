...
#define THRESH_BUMP_G               0.15  // bump detection threshold
...
#define THRESH_THROTTLE_RATE_PPS    300.0  // per second

/* --- 3. TMAP Segment Config --- */
#define SEGMENT_DISTANCE_KM         0.05   // 50m Segment
#define MAX_SEGMENT_HISTORY         6
#define SEGMENT_TIMEOUT_TICKS       90000   // 90000 ticks = 900s timeout
